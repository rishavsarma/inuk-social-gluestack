        ...
        <VStack space="lg">
          ...
          <FormControl isInvalid={!!referralError} className="w-full">
            <VStack space="xs">
                  ...
                  <HStack space="md" className="items-center">
                    <Avatar className="h-10 w-10">
                      ...
                      {referrer.avatar ? (
                        <AvatarImage
                          source={{
                            uri: buildImageUrl(referrer.avatar, 150),
                          }}
                        />
                      ) : null}
                    </Avatar>
              ...
              {referralError && (
                <FormControlError>
                  <FormControlErrorText>{referralError}</FormControlErrorText>
                </FormControlError>
              )}
            </VStack>
          </FormControl>
          ...
          <AuthSubmitButton
            label={t("auth.referral_continue_button")}
            onPress={handleContinue}
            isLoading={isCheckingReferralCode}
