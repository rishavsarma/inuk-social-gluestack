...
const buttonStyle = tva({
  ...
  variants: {
    variant: {
      ...
      outline:
        "border border-border bg-background shadow-none shaodow-0 data-[hover=true]:bg-accent data-[active=true]:bg-accent dark:bg-input/[0.045] dark:border-border/90 dark:data-[hover=true]:bg-input/[0.075] dark:data-[active=true]:bg-input/[0.075]",
      secondary:
