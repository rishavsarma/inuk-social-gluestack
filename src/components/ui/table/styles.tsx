...
export const tableHeadStyle = tva({
  base: "flex-1 px-6 py-[14px] text-left font-bold text-[16px] leading-[22px] text-foreground/80",
});
...
export const tableDataStyle = tva({
  base: "flex-1 px-6 py-3.5 text-left text-[16px] font-medium leading-5.5 text-foreground/80",
});

export const tableCaptionStyle = tva({
  base: `${captionTableStyle} px-6 py-3.5 text-[16px] font-normal leading-5.5 text-foreground/90 bg-background/90`,
});
